...
function syncLabel() {
  ...
  return {ok:'sincronizado', pend:'sincronizando…', err:'itens c/ erro — ver Saúde', pausado:'sinc. pausada — retomar', auth:'entrar p/ sincronizar', off:'Supabase indisponível'}[syncStatus()];
}
